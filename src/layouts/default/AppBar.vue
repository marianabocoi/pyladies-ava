<template>
  <v-app-bar flat>
    <v-app-bar-title>
      <img src="/logo.svg" height="35" style="vertical-align:middle" />
      PyLadies Ava
    </v-app-bar-title>
    <v-btn icon href="https://github.com/marianabocoi/pyladies-ava" target="_blank" justify="center">
        <svg  height="60"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" >
        <path fill="#000000" fill-rule="evenodd" stroke-width=0px
